          ...
          >
            ...
            <div className="mentor-stats-row" style={{ display: 'flex', gap: '32px', flexWrap: 'wrap' }}>
              <div className="mentor-stat-item">
                <h3 style={{ fontSize: '2rem', color: 'var(--color-primary)', fontFamily: 'var(--font-heading)' }}>8+ Yrs</h3>
              ...
              <div className="mentor-stat-item">
                <h3 style={{ fontSize: '2rem', color: 'var(--color-success)', fontFamily: 'var(--font-heading)' }}>100+</h3>
              ...
              <div className="mentor-stat-item">
                <h3 style={{ fontSize: '2rem', color: 'var(--color-accent)', fontFamily: 'var(--font-heading)' }}>10k+</h3>
