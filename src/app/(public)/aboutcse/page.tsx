      ...
      <section className="about-hero">
        <div className="container" style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
          <motion.h1 
            ...
            className="text-3xl sm:text-4xl font-bold font-serif text-[#0b3b60]"
          >
          ...
          <motion.p 
            ...
            style={{ fontSize: '1.05rem', color: 'var(--text-secondary)', lineHeight: 1.6, marginTop: '12px' }}
          >
          ...
          <div className="hero-anchors">
            ...
            <button 
              className={`pill-btn ${activeTab === 'eligibility' ? 'active' : ''}`}
              onClick={() => setActiveTab('eligibility')}
            >
              Eligibility & Limits
            </button>
            <button 
              className={`pill-btn ${activeTab === 'syllabus' ? 'active' : ''}`}
          ...
          <div className="tab-main-content">
            ...
            {activeTab === 'overview' && (
              ...
              >
                <div className="section-header" style={{ textAlign: 'left', marginBottom: '32px' }}>
                  <h2>Institutional Origins of the Civil Services</h2>
                  <p>A historical overview of public administration in India from early East India Company patronage to modern constitutional safeguards under Part XIV.</p>
                </div>
                ...
                <div className="article-prose">
                  <div className="highlight-callout">
                    <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                      ...
                      <div>
                        <h4 style={{ fontWeight: 700, marginBottom: '6px', color: '#0b3b60' }}>Constitutional Mandate: Article 315 to 323</h4>
                  ...
                  <h3 style={{ marginTop: '32px', marginBottom: '16px', fontSize: '1.4rem' }}>Evolution of Merit Selection</h3>
                ...
                <div className="history-timeline">
                  <div className="timeline-card">
                    ...
                    <div className="timeline-header">
                      <h3>Macaulay Report</h3>
                    </div>
                    <p>
                      Abolished the nomination system and instituted open competition to select individuals with strong academic and intellectual capabilities.
                    </p>
                  </div>

                  <div className="timeline-card">
                    <div className="timeline-year">1926</div>
                    <div className="timeline-header">
                      <h3>First PSC Formed</h3>
                    </div>
                    <p>
                      Under Sir Ross Barker, the initial four-member commission conducted selections for the elite Indian Civil Service (ICS) and Indian Police (IP).
                    </p>
                  </div>
                ...
                {syllabusStage === 'mains' && (
                  <div className="space-y-8">
                    ...
                    <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-xs">
                      ...
                      <div className="text-xs sm:text-sm text-slate-700 space-y-2 leading-relaxed bg-slate-50/80 p-4 rounded-lg border border-slate-200">
                        <p>
            ...
            {activeTab === 'salary' && (
              ...
              >
                ...
                <div className="section-header" style={{ textAlign: 'left', marginBottom: '24px' }}>
                  <h3>All-India & Central Services Groupings</h3>
                  <p>Recruitment through the CSE allocates candidates across 3 premier All-India Services and various Group 'A' and 'B' Central Services.</p>
                </div>
                ...
                <div className="feature-grid-3">
                  <div className="info-card">
                    ...
                    <ul className="topic-list" style={{ marginTop: '12px' }}>
                  ...
                  <div className="info-card">
                    <div className="info-card-header">
                      ...
                      <h3>Group 'A' Central Services</h3>
                    </div>
                    <ul className="topic-list" style={{ marginTop: '12px' }}>
                  ...
                  <div className="info-card">
                    <div className="info-card-header">
                      ...
                      <h3>Group 'B' Central Services</h3>
                    </div>
                    <ul className="topic-list" style={{ marginTop: '12px' }}>
            ...
            <div className="faq-section" style={{ marginTop: '64px' }}>
              <div className="section-header" style={{ textAlign: 'left', marginBottom: '24px' }}>
                <h3 className="text-xl font-bold font-serif text-[#0b3b60]">Frequently Asked Questions</h3>
                <p className="text-xs text-slate-600">Clarifications on scoring formulas, calculator regulations, and commission origins.</p>
              </div>
              ...
              <div className="space-y-3">
                {faqsList.map((faq) => (
                  <div key={faq.id} className="faq-accordion-item">
                    ...
                    >
                      <span style={{ fontWeight: 600, color: 'var(--text-primary)' }}>{faq.question}</span>
                      <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${activeFaq === faq.id ? 'rotate-180' : ''}`} />
                    </button>
                    <AnimatePresence>
                      {activeFaq === faq.id && (
                        <motion.div
                        ...
                        >
                          <div className="faq-accordion-body text-xs sm:text-sm text-slate-600 leading-relaxed">
                            {faq.answer}
                          </div>
                        </motion.div>
                      )}
